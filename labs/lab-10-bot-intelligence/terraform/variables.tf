...
variable "version_group_id" {
  description = "Optional EdgeOne L7 configuration group ID. Used by Lab 12 and later."
  type        = string
  default     = null
}

variable "version_env_id" {
  description = "Optional EdgeOne environment ID used when enable_version_deploy is true. Used by Lab 12 and later."
  type        = string
  default     = null
}
